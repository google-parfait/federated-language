...
from federated_language.program import program_state_manager
...
class _TestProgramStateManager(
  ...
  """A test implementation of `federated_language.program.ProgramStateManager`.

  A `federated_language.program.ProgramStateManager` cannot be constructed
  directly because it
  has abstract methods, this implementation exists to make it possible to
  construct instances of `federated_language.program.ProgramStateManager` that
  can used as
  stubs or mocked.
  """
