...
This example demonstrates how to represent logic from other computational
libraries (e.g., TensorFlow, JAX, PyTorch) as a Federated Language computation.
...
def computation(
  ...
  functions from other computational libraries (e.g., TensorFlow, JAX, PyTorch)
  because those libraries limit the expressiveness of Python.
  ...
  def _decorator(
    ...
    return wraps_decorator(comp)  # pytype: disable=bad-return-type
